      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-8">
        <header className="text-center space-y-2">
          ...
          <p className="text-sm sm:text-base text-zinc-600 max-w-2xl mx-auto">
            ...
            Parlios réfléchit avec toi et te propose le meilleur chemin.
          </p>
        </header>
        ...
        {/* Raccourcis plus petits, en ligne, scroll horizontal */}
        <section className="space-y-3">
            ...
            {MISSIONS.map((mission) => {
              ...
              return (
                <button
                  ...
                  className={[
                    "whitespace-nowrap inline-flex items-center rounded-full border px-3 py-1 text-xs transition",
                    isActive
          ...
          <p className="text-[11px] text-center text-zinc-500">
            Tu peux utiliser les raccourcis ou simplement écrire ton idée dans le chat,
            comme sur Kimi ou Skywork.
          </p>
        </section>
